...
public class MyBluetoothSerialService extends Service {
    ...
    private Handler mHandlerActivity; // Hilo para comunicar el estado de la conexion al hilo principal de activity
     ConnectThread mConnectThread; // Hilo para intentar conectarse
...
//                Log.e(TAG, "temp sockets not created", e);
            ...
            while (true) {
                try {
                   ...
                   if (validando.equals("01HIDE OK\n\r")) {
                       Message readMsgH = mHandlerActivity.obtainMessage(
                               Constants.ESTADO_HIDE, length, -1,
                               data);
                       readMsg.sendToTarget();
        ...
        public String leerDato() {
            ...
            while (true) {
                try {
                    ...
                    Log.i(TAG, "AQUI " + validando);
                    vall = validando;
                    Message readMsg = mHandlerActivity.obtainMessage(Constants.ESTADO_HIDE, length, -1,
                            data);
                    readMsg.sendToTarget();
    ...
    public String serialLeerFin() {
        this.serialLeer();
        String lectura;
        lectura= mConnectedThread.leerDato();
        return lectura;
    }
